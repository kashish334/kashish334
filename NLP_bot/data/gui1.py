...
class ChatbotGUI:
    ...
    def setup_gui(self):
        ...
        input_frame.pack(fil=tk.X, pady=5)
        ...
        self.help_button = ttk.Button(button_frame, text="help Chat", command=self.show_help)
        self.help_button.pack(side=tk.RIGHT)

    def load_chatbot_data(self):
        self.lemmatizer = WordNetLemmatizer()
        self.intents = json.loads(open(r"data/intents.json").read())
        self.words = pickle.load(open(r"words.pkl", "rb"))
        self.classes = pickle.load(open(r"classes.pkl", "rb"))
        self.model = load_model(r"chatbot_model.h5")
